...
module.exports = {
     ...
     */
    botname: process.env.BotName || "FAST-BOT⚙️",
    footer: process.env.Footer || "© 𝐏𝐨𝐰𝐞𝐫𝐞𝐝 𝐁𝐲 fast  igwe  𝐁𝐨𝐭",
    ...
    instagramId: process.env.Insta || "techigwe",

    /**
     * other details and parameters
     */
    author: process.env.Author || "fåst~bøt 🌚🌙",
    packname: process.env.PackName || "fast 𝖁ot 𝕾𝖙𝖎𝖈𝖐𝖊𝖗 𝕻𝖆𝖈𝖐 🪀",
    socialLink: process.env.Web || "https://github.com/papaigwe",
    groupLink: process.env.GcLink || "https://whatsapp.com/channel/0029VaomOwSFsn0XoleOJ41u",
    warns: Number(process.env.Warn_Limits) || 3,
    cooldown: Number(process.env.Cooldown_Timer_Seconds) || 5, // default cooldown time per command in seconds
    mongoUrl: process.env.MongoDB || "mongosh "mongosh "mongodb+srv://igwe.vweay.mongodb.net/" --apiVersion 1 --username Papaigwe --password OjUeUnfScrzk84HT",
    sessionId: process.env.SESSION_ID || "NXdtc2Q_Queen-Anya_3YXM=",
    ...
    imageUrl: "https://i.imgur.com/oJdAgjt.jpeg", // image url, to replace to your url upload your image to https://imgbb.com
    imageMentionUrl: "https://i.imgur.com/oJdAgjt.jpeg", // image for mention reply audio media
